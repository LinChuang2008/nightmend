...
- [用户手册 v1.1](docs/user-manual.md) — 菜单导览 · 常用场景 · 权限

**给运维**
- [部署手册 v1.1](docs/deployment.md) — `deploy.sh` · 生产加固 · HTTPS · 备份
- [安装指南](docs/installation.md) — 详细 Docker Compose 手册
- [Agent 安装](docs/agent-install.md) — Linux / Windows / K8s / Ansible
- [Windows Agent](docs/windows-agent-install.md)

**给二开**
- [代码导览 Code Guide](docs/code-guide.md) — 二开地图 · 扩展 walkthrough · 约定
